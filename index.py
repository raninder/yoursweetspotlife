...
class user:
  ...
  def widgets(self):
    ...
    Entry(self.logf, textvariable=self.username, bd=5,
    ...
    Label(self.crf, text='Username: ', font=('', 20), pady=5,
          padx=5).grid(sticky=W)
    Entry(self.crf, textvariable=self.n_username, bd=5,
          font=('', 15)).grid(row=0, column=1)
    Label(self.crf, text='Password: ', font=('', 20), pady=5,
          padx=5).grid(sticky=W)
    Entry(self.crf,
          textvariable=self.n_password,
          bd=5,
          font=('', 15),
          show='*').grid(row=1, column=1)
    Button(self.crf,
...
class travel:
  ...
  def __init__(self, root):
    self.root = root
    self.root.title("Your Sweet Spot Life Transportation Booking System")
    ...
    def Receiptt():
      if reset_counter == 0 and Firstname.get() != "" and Lastname.get(
      ) != "" and Address.get() != "" and Postcode.get() != "" and Mobile.get(
      ) != "" and Telephone.get() != "" and Email.get() != "":
        self.txtReceipt1.delete("1.0", END)
        self.txtReceipt2.delete("1.0", END)
    ...
    def Kilo():
      if var2.get() == 0:
        ...
        if varl1.get() == "Address3":
          ...
          Km.set(switch[varl2.get()])
        elif varl1.get() == "Address2":
          switch = {"Address1": 2, "Address2": 0, "Address4": 3, "Address3": 8}
          Km.set(switch[varl2.get()])
        elif varl1.get() == "Address4":
          switch = {"Address1": 5, "Address2": 3, "Address4": 0, "Address3": 6}
          Km.set(switch[varl2.get()])
    ...
    def Total_Paid():
      if ((var1.get() == 1 and var2.get() == 1 and var3.get() == 1
           or var4.get() == 1) and carType.get() != 0
          and journeyType.get() != 0
          and (varl1.get() != "" and varl2.get() != "")):
...
#================================================mainframe========================================================================
    ...
    self.lblTitle = Label(Tops,
                          font=('arial', 50, 'bold'),
                          text="\t   Your Sweet Spot Life Transportation ")
    self.lblTitle.grid()
    ...
    self.lblLastname = Label(CustomerName,
                             font=('arial', 14, 'bold'),
                             text="Lastname",
                             bd=7)
    self.lblLastname.grid(row=1, column=0, sticky=W)
    self.txtLastname = Entry(CustomerName,
                             font=('arial', 14, 'bold'),
    ...
    self.cboPickup = ttk.Combobox(TravelFrame,
                                  ...
                                  font=('arial', 20, 'bold'),
                                  width=14)
    self.cboPickup['value'] = ('', 'Address3', 'Address4', 'Address2',
                               'Address1')
    self.cboPickup.current(0)
    ...
    self.cboDrop = ttk.Combobox(TravelFrame,
                                ...
                                font=('arial', 20, 'bold'),
                                width=14)
    self.cboDrop['value'] = ('', 'Address1', 'Address2', 'Address3',
                             'Address4')
    self.cboDrop.current(0)
    ...
    self.chkKm = Checkbutton(TravelFrame,
                             text="Distance(KMs) *",
                             variable=var2,
                             onvalue=1,
                             offvalue=0,
    ...
    self.chkStandard = Radiobutton(Book_Frame,
                                   text="Glen's Car",
                                   value=1,
                                   variable=carType,
                                   font=('arial', 14, 'bold'),
                                   command=selectCar).grid(row=0,
                                                           column=0,
                                                           sticky=W)
    self.txtStandard = Label(Book_Frame,
                             font=('arial', 14, 'bold'),
                             width=7,
                             textvariable=Standard,
                             bd=5,
                             state=DISABLED,
                             justify=RIGHT,
                             bg="white",
    ...
    self.chkFordGalaxyd = Radiobutton(Book_Frame,
                                      text="Glen's Second Car",
                                      value=2,
                                      variable=carType,
                                      font=('arial', 14, 'bold'),
                                      command=selectCar).grid(row=1,
                                                              column=0,
                                                              sticky=W)
    self.txtFordGalaxy = Label(Book_Frame,
                               font=('arial', 14, 'bold'),
                               width=7,
                               textvariable=FordGalaxy,
                               bd=5,
                               state=DISABLED,
                               justify=RIGHT,
                               bg="white",
    ...
    self.chkFordMondeo = Radiobutton(Book_Frame,
                                     text="Glen's Third Car",
                                     value=3,
                                     variable=carType,
                                     font=('arial', 14, 'bold'),
                                     command=selectCar).grid(row=2, column=0)
    self.txtFordMondeo = Label(Book_Frame,
                               font=('arial', 14, 'bold'),
                               width=7,
                               textvariable=FordMondeo,
                               bd=5,
                               state=DISABLED,
                               justify=RIGHT,
                               bg="white",
